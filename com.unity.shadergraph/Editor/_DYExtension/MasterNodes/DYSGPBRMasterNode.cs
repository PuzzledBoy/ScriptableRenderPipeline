...
namespace UnityEditor.ShaderGraph.DY
{
    [Serializable]
    [Title("DY", "PBR")]
    class DYSGPBRMasterNode : DYSGMasterNode<IDYSGPBRSubShader>, IMayRequirePosition, IMayRequireNormal, IMayRequireTangent
    {
        ...
        [SerializeField] Model m_Model = Model.Metallic;
        ...
        {
            return new DYSGPBRSettingView(this);
        }

        public sealed override void UpdateNodeAfterDeserialization()
        {
            base.UpdateNodeAfterDeserialization();
            name = "DYSG PBR Master";
